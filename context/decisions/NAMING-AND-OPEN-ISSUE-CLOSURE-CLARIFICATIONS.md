...
- Narrow the naming rule to governed created entry files and narrow closure decisions to real CEO-approved truth changes only.
...
- open-issue closure creates a frozen decision only when the closure itself creates or changes frozen repo truth
